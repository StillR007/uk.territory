function showPopup(event) {
	...
	let link = this.closest('.appeals-main__column-5').closest('.appeals-main').querySelector('.appeals-main__number');
	document.querySelector('#appeal-id').setAttribute('value', `${link.innerText}`);
...
let buttonsNode = document.querySelectorAll('.btn.btn-territory.post-comment');
let buttons = [...buttonsNode];
...
const allAppeals = document.querySelectorAll('.appeals-main.active');